...
-->
<span  style="color: gray;"><span align="left" style="font-size: 20px;"><a href="home.php">Chess</a></span><span align="right"><a style="color: gray" ><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;<span >Welcome &nbsp;<?php echo $_SESSION["name"]; ?></span></a></span>
